            ...
            <li className='cards__item'>
                <Link className='cards__item__link' to={props.path}>
                    ...
                    <div className='cards__item__info'>
                        ...
                        <p className='cards__item__text'>{lineOne}</p>
                        <p className='cards__item__text'>{lineTwo}</p>
                        <p className='cards__item__text'>{lineThree}</p>
                        <p className='cards__item__text'>{lineFour}</p>
                        <p className='cards__item__text'>{lineFive}</p>
                        <p className='cards__item__text'>{lineSix}</p>
